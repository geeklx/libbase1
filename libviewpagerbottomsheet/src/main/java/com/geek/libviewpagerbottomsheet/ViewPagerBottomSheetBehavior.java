...
public class ViewPagerBottomSheetBehavior<V extends View> extends CoordinatorLayout.Behavior<V> {
    ...
    /**
     *
     * @param halfExpandedOffset
     * @attr ref
     */
    public void setHalfExpandedOffset(int halfExpandedOffset) {
    ...
    /**
     * Gets the halfExpandedOffset for the height of the BottomSheet in the {@link #STATE_HALF_EXPANDED} state.
     *
     * @attr ref
     */
    ...
    private void setSystemGestureInsets(@NonNull CoordinatorLayout parent) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q && !isGestureInsetBottomIgnored()) {
    ...
    void dispatchOnSlide(int top) {
        ...
        if (bottomSheet != null && !callbacks.isEmpty()) {
            ...
            for (int i = 0; i < callbacks.size(); i++) {
                callbacks.get(i).onSlide(bottomSheet, top);
            }
        }
    }
