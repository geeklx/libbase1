package com.geek.libocr.base;//LoadFile工具类
...
public class LoadFile {
    ...
    public static File copyInputStreamToFile(InputStream inputStream) throws IOException {
        File file = new File(getSDPath(TsfApp.get()) + "tsf.md");//临时读取的文件，要保证路径存在
    ...
    public static List<XmlBean> getNodeList(InputStream inputStream) throws Exception {
        List<XmlBean> mlist = new ArrayList<>();
        //获取DOM解析器工厂
