...
//        }).start();
        //
//        PictureSelector.create(ScanAct1.this)
...
//                                        //
//                                        final String s = ScannerUtils.decodeText(ImgUrl);
...
//                                        final String s;
//                                        try {
//                                            s = String.valueOf(ScannerUtils.decodeNsfw(ScanAct1.this, bitmap));
