...
import com.geek.libbroccoli1.broccoli.PlaceholderParameter;
    ...
    public static PlaceholderParameter getParameter(View view) {
        ...
        if (id == R.id.tv_view_time) {
            return new PlaceholderParameter.Builder()
                    ...
                    .build();
        } else if (id == R.id.tv_collect_time) {
            return new PlaceholderParameter.Builder()
                    .setView(view)
                    .setDrawable(DrawableUtils.createRectangleDrawable(placeHolderColor, 0))
                    .build();
            ...
            return new PlaceholderParameter.Builder()
                    ...
                    .setDrawable(DrawableUtils.createOvalDrawable(placeHolderColor))
                    .build();
        } else if (id == R.id.tv_organizer_name) {
            ...
            return new PlaceholderParameter.Builder()
                    ...
                    .setDrawable(DrawableUtils.createRectangleDrawable(placeHolderColor, 5))
                    .build();
        } else if (id == R.id.tv_organizer_description) {
            ...
            return new PlaceholderParameter.Builder()
                    ...
                    .setDrawable(DrawableUtils.createRectangleDrawable(placeHolderColor, 0))
                    .build();
        } else if (id == R.id.tv_events) {
            return new PlaceholderParameter.Builder()
                    .setView(view)
                    .setDrawable(DrawableUtils.createRectangleDrawable(placeHolderColor, 0))
                    .build();
        } else if (id == R.id.tv_events_number) {
            return new PlaceholderParameter.Builder()
                    .setView(view)
                    .setDrawable(DrawableUtils.createRectangleDrawable(placeHolderColor, 0))
                    .build();
