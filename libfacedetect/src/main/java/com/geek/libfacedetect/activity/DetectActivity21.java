...
//                        Log.e("ssssssssssss-mDetectedFace", mDetectedFace.getByteCount() + "");
...
//                            Log.e("ssssssssssssmDetectedFace", mDetectedFace.getByteCount() + "");
                            intent = new Intent(DetectActivity21.this,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initWindowSettings();
        setContentView(R.layout.activty_detectfacedetector21);
...
//        cameraView.enableView();
        DatabaseHelper helper = new DatabaseHelper(DetectActivity21.this);
