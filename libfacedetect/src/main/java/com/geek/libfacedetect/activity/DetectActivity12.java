...
public class DetectActivity12 extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initWindowSettings();
        setContentView(R.layout.activty_detectfacedetector12);
    ...
    private void initClassifier() {
        ...
        DatabaseHelper helper = new DatabaseHelper(DetectActivity12.this);
...
//                            Log.e("ssssssssssssmDetectedFace", mDetectedFace.getByteCount() + "");
                            intent = new Intent(DetectActivity12.this,
