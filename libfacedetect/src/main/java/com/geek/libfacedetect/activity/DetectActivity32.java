...
public class DetectActivity32 extends CameraActivity implements CvCameraViewListener2 {
                ...
                case FLAG_REGISTER:
                    if (mDetectedFace == null) {
                        ...
                        if (result == matcher.UNFINISHED) {
                            ...
                            intent = new Intent(DetectActivity32.this,
...
//                })
        ...
        DatabaseHelper helper = new DatabaseHelper(DetectActivity32.this);
