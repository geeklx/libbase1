 ...
 */
public class JavaCameraView2 extends CameraBridgeViewBase2 implements PreviewCallback {
...
//    }
    ...
    private class JavaCameraFrame implements CvCameraViewFrame2 {
        @Override
        public Mat gray() {
    ...
    private class CameraWorker implements Runnable {
        ...
        public void run() {
            do {
                ...
                synchronized (JavaCameraView2.this) {
                    try {
                        while (!mCameraFrameReady && !mStopThread) {
                            JavaCameraView2.this.wait();
                        }
                    } catch (InterruptedException e) {
                        e.printStackTrace();
                    }
