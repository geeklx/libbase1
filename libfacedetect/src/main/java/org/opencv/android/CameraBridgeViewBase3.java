 ...
 */
public abstract class CameraBridgeViewBase3 extends SurfaceView implements SurfaceHolder.Callback {
    ...
    public CameraBridgeViewBase3(Context context, int cameraId) {
        super(context);
    ...
    public CameraBridgeViewBase3(Context context, AttributeSet attrs) {
        super(context, attrs);
