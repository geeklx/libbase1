...
public class CameraPreview extends JavaCameraViewWrapper implements ICameraPreview {
    ...
    protected Size calculateCameraFrameSize(List<?> supportedSizes, ListItemAccessor accessor, int surfaceWidth, int surfaceHeight) {
        ...
        if (mPreviewManager.isUseOpenCvDefaultFrameSizeCalculator) {
            size = super.calculateCameraFrameSize(supportedSizes, accessor, surfaceWidth / 2, surfaceHeight / 2);
        } else {
            ...
            size = mPreviewManager.cameraFrameSizeCalculator.calculateCameraFrameSize(sizes, surfaceWidth / 2, surfaceHeight / 2);
        }
