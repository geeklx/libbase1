package com.geek.libpicturerecognitiontext.pictureselector.adapter;
...
import com.geek.libpicturerecognitiontext.pictureselector.listener.OnItemLongClickListener;
        ...
        if (getItemViewType(position) == TYPE_CAMERA) {
            ...
            if (chooseModel == PictureMimeType.ofAudio()) {
                ...
                viewHolder.tvDuration.setCompoundDrawablesRelativeWithIntrinsicBounds
                        (com.luck.picture.lib.R.drawable.picture_icon_audio, 0, 0, 0);

            } else {
                viewHolder.tvDuration.setCompoundDrawablesRelativeWithIntrinsicBounds
                        (com.luck.picture.lib.R.drawable.picture_icon_video, 0, 0, 0);
            }
