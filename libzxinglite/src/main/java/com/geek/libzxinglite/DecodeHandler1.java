...
final class DecodeHandler1 extends Handler {
    ...
    private final CaptureHandler1 handler;
    private final MultiFormatReader multiFormatReader;
    private boolean running = true;

    private long lastZoomTime;

    DecodeHandler1(Context context, CameraManager cameraManager, CaptureHandler1 handler, Map<DecodeHintType, Object> hints) {
