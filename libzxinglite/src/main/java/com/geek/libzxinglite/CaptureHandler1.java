 ...
 */
public class CaptureHandler1 extends Handler implements ResultPointCallback {

    private static final String TAG = CaptureHandler1.class.getSimpleName();

    private final OnCaptureListener onCaptureListener;
    private final DecodeThread1 decodeThread;
    private State state;
    private final CameraManager cameraManager;
    private final ViewfinderViews viewfinderView;
    /**
     * 是否支持垂直的条形码
     */
    ...
    CaptureHandler1(Activity activity, ViewfinderViews viewfinderView, OnCaptureListener onCaptureListener,
        ...
        decodeThread = new DecodeThread1(activity, cameraManager, this, decodeFormats, baseHints, characterSet, this);
        decodeThread.start();
        state = State.SUCCESS;
