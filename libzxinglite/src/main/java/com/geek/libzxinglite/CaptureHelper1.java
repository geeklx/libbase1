...
import com.geek.libzxinglite.camera.CameraManager;
 ...
 * @author <a href="mailto:jenly1314@gmail.com">Jenly</a>
 */
public class CaptureHelper1 implements CaptureLifecycle, CaptureTouchEvent, CaptureManager, SurfaceHolder.Callback {

    private Activity activity;

    private CaptureHandler1 captureHandler;
    ...
    /**
     * use {@link #CaptureHelper(Fragment, SurfaceView, ViewfinderViews, View)}
     *
     * @param fragment
     * @param surfaceView
     ...
     */
    @Deprecated
    public CaptureHelper1(Fragment fragment, SurfaceView surfaceView, ViewfinderViews viewfinderView) {
        this(fragment, surfaceView, viewfinderView, null);
    }

    public CaptureHelper1(Fragment fragment, SurfaceView surfaceView, ViewfinderViews viewfinderView, View ivTorch) {
        this(fragment.getActivity(), surfaceView, viewfinderView, ivTorch);
    }

    /**
     * use {@link #CaptureHelper(Activity, SurfaceView, ViewfinderViews, View)}
     *
     * @param activity
     * @param surfaceView
     * @param viewfinderView
     */
    @Deprecated
    public CaptureHelper1(Activity activity, SurfaceView surfaceView, ViewfinderViews viewfinderView) {
     ...
     * @param ivTorch
     */
    public CaptureHelper1(Activity activity, SurfaceView surfaceView, ViewfinderViews viewfinderView, View ivTorch) {
    ...
    private void initCamera(SurfaceHolder surfaceHolder) {
        ...
        try {
            ...
            if (captureHandler == null) {
                captureHandler = new CaptureHandler1(activity, viewfinderView, onCaptureListener, decodeFormats, decodeHints, characterSet, cameraManager);
     ...
     */
    public CaptureHelper1 continuousScan(boolean isContinuousScan) {
     ...
     * @return 默认返回 true
     */
    public CaptureHelper1 autoRestartPreviewAndDecode(boolean isAutoRestartPreviewAndDecode) {
     ...
     * @return
     */
    public CaptureHelper1 playBeep(boolean playBeep) {
     ...
     * @return
     */
    public CaptureHelper1 vibrate(boolean vibrate) {
     ...
     * @return
     */
    public CaptureHelper1 supportZoom(boolean supportZoom) {
     ...
     * @return
     */
    public CaptureHelper1 decodeFormats(Collection<BarcodeFormat> decodeFormats) {
     ...
     * @return
     */
    public CaptureHelper1 decodeHints(Map<DecodeHintType, Object> decodeHints) {
     ...
     * @return
     */
    public CaptureHelper1 decodeHint(DecodeHintType key, Object value) {
        if (decodeHints == null) {
     ...
     * @return
     */
    public CaptureHelper1 characterSet(String characterSet) {
     ...
     * @return
     */
    public CaptureHelper1 supportVerticalCode(boolean supportVerticalCode) {
     ...
     * @return
     */
    public CaptureHelper1 frontLightMode(FrontLightMode mode) {
     ...
     * @return
     */
    public CaptureHelper1 tooDarkLux(float tooDarkLux) {
     ...
     * @return
     */
    public CaptureHelper1 brightEnoughLux(float brightEnoughLux) {
     ...
     * @return
     */
    public CaptureHelper1 returnBitmap(boolean returnBitmap) {
     ...
     * @return
     */
    public CaptureHelper1 supportAutoZoom(boolean supportAutoZoom) {
     ...
     * @return
     */
    public CaptureHelper1 supportLuminanceInvert(boolean supportLuminanceInvert) {
     ...
     * @return
     */
    public CaptureHelper1 fullScreenScan(boolean fullScreenScan) {
     ...
     * @return
     */
    public CaptureHelper1 framingRectRatio(@FloatRange(from = 0.0f, to = 1.0f) float framingRectRatio) {
     ...
     * @return
     */
    public CaptureHelper1 framingRectVerticalOffset(int framingRectVerticalOffset) {
     ...
     * @return
     */
    public CaptureHelper1 framingRectHorizontalOffset(int framingRectHorizontalOffset) {
     ...
     * @return
     */
    public CaptureHelper1 setOnCaptureCallback(OnCaptureCallback callback) {
