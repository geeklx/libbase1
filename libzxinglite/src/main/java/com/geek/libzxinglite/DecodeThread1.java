...
final class DecodeThread1 extends Thread {
    ...
    DecodeThread1(Context context, CameraManager cameraManager,
                  CaptureHandler1 captureHandler,
    ...
    public void run() {
        Looper.prepare();
        handler = new DecodeHandler1(context, cameraManager, captureHandler, hints);
