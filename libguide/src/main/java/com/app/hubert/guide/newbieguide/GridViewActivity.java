...
public class GridViewActivity extends AppCompatActivity {
    ...
    public List<Map<String, Object>> getList() {
        ...
        Integer[] images = {R.drawable.default_unknow_image2, R.drawable.default_unknow_image2,
                R.drawable.default_unknow_image2, R.drawable.default_unknow_image2, R.drawable.default_unknow_image2, R.drawable.default_unknow_image2,
                R.drawable.default_unknow_image2, R.drawable.default_unknow_image2, R.drawable.default_unknow_image2};
