...
public class BieGuideMainActivity extends AppCompatActivity {

    private final String TAG = this.getClass().getSimpleName();

    public static void start(Context context) {
        Intent starter = new Intent(context, BieGuideMainActivity.class);
...
//        StatusBarUtil.setTranslucent(this, 0);
        setContentView(R.layout.activity_main_bieguide);
        ...
        textView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                GridViewActivity.start(BieGuideMainActivity.this);
            }
        });
        ...
        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                TestFragmentActivity.start(BieGuideMainActivity.this);
            }
        });
...
//                .anchor(anchor)
                ...
                .setOnPageChangedListener(new OnPageChangedListener() {
                    ...
                    public void onPageChanged(int page) {
                        ...
                        Toast.makeText(BieGuideMainActivity.this, "引导页切换：" + page, Toast.LENGTH_SHORT).show();
                    }
                })
