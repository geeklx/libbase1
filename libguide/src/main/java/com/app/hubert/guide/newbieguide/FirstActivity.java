...
import com.app.hubert.guide.guideview.newguideview.SimpleGuideViewActivity1;
...
public class FirstActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Button btnliandong = findViewById(R.id.btn_liandong);
        final Button btnliandong1 = findViewById(R.id.btn_liandong1);
        btnliandong.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(FirstActivity.this, SimpleGuideViewActivity.class));
            }
        });
        btnliandong1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(FirstActivity.this, SimpleGuideViewActivity1.class));
            }
        });
...
//                        .setShowCounts(3)//控制次数
        ...
        findViewById(R.id.btn_multi).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                BieGuideMainActivity.start(FirstActivity.this);
            }
        });
