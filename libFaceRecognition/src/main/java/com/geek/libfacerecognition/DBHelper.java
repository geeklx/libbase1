...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public void getAllUsers() {
        ...
        while(res.isAfterLast() == false){
            @SuppressLint("Range") int user_id = res.getInt(res.getColumnIndex(CONTACTS_COLUMN_ID));
            ...
            @SuppressLint("Range") byte[] featureData = res.getBlob(res.getColumnIndex(CONTACTS_COLUMN_FEATURE));
            ...
            FaceMainActivity.userLists.add(face);
