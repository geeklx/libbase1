package coms.luck.picture.lib.adapter;
...
public class PicturePreviewAdapter extends RecyclerView.Adapter<BasePreviewHolder> {
    ...
    public BasePreviewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if (viewType == BasePreviewHolder.ADAPTER_TYPE_VIDEO) {
            ...
            return BasePreviewHolder.generate(parent, viewType, layoutResourceId != InjectResourceSource.DEFAULT_LAYOUT_RESOURCE ? layoutResourceId : R.layout.gps_preview_video);
            ...
            return BasePreviewHolder.generate(parent, viewType, layoutResourceId != InjectResourceSource.DEFAULT_LAYOUT_RESOURCE ? layoutResourceId : R.layout.gps_preview_audio);
        } else {
            ...
            return BasePreviewHolder.generate(parent, viewType, layoutResourceId != InjectResourceSource.DEFAULT_LAYOUT_RESOURCE ? layoutResourceId : R.layout.gps_preview_image);
        }
    }
