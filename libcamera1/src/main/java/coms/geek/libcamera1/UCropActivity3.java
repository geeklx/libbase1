...
import coms.yalantis.ucrop.util.FileUtils;
import coms.yalantis.ucrop.util.SelectedStateListDrawable;
import coms.yalantis.ucrop.view.CropImageView;
import coms.yalantis.ucrop.view.GestureCropImageView;
import coms.yalantis.ucrop.view.OverlayView;
import coms.yalantis.ucrop.view.TransformImageView;
import coms.yalantis.ucrop.view.UCropView;
import coms.yalantis.ucrop.view.widget.AspectRatioTextView;
import coms.yalantis.ucrop.view.widget.HorizontalProgressWheelView;
...
public class UCropActivity3 extends AppCompatActivity {
...
//    }
    ...
    private void setImageData(@NonNull Intent intent) {
        ...
        if (inputUri != null && outputUri != null) {
            try {
                ...
                outputUri = FileUtils.replaceOutputUri(UCropActivity3.this, isForbidCropGifWebp, inputUri, outputUri);
    ...
    private void processOptions(@NonNull Intent intent) {
        ...
        mCompressQuality = intent.getIntExtra(UCrop.Options.EXTRA_COMPRESSION_QUALITY, UCropActivity3.DEFAULT_COMPRESS_QUALITY);
...
//            public void onClick(View view) {
//                //
////                EventBus.getDefault().post(new BjyyBeanYewu3("重拍",""));
//            }
//        });
//
//
...
//        }
    ...
    private TransformImageView.TransformImageListener mImageListener = new TransformImageView.TransformImageListener() {
        ...
        public void onLoadComplete() {
            ...
            if (getIntent().getBooleanExtra(UCrop.Options.EXTRA_CROP_FORBID_GIF_WEBP, false)) {
                ...
                String mimeType = FileUtils.getMimeTypeFromMediaContentUri(UCropActivity3.this, inputUri);
    ...
    private void setupAspectRatioWidget(@NonNull Intent intent) {
        ...
        for (AspectRatio aspectRatio : aspectRatioList) {
            wrapperAspectRatio = (FrameLayout) getLayoutInflater().inflate(R.layout.gucrop_aspect_ratio, null);
    ...
    protected void setResultUri(Uri uri, float resultAspectRatio, int offsetX, int offsetY, int imageWidth, int imageHeight) {
        ...
        String aaa = FileUtils.getInputPath(inputUri);
        String aaaa = "";
    }
