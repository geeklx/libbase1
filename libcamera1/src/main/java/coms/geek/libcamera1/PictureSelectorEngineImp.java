...
public class PictureSelectorEngineImp implements PictureSelectorEngine {
    ...
    public ImageEngine createImageLoaderEngine() {
        ...
        return GlideEngine1.createGlideEngine();
    }
