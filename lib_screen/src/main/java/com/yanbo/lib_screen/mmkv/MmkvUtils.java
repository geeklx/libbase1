package com.yanbo.lib_screen.mmkv;
...
import com.yanbo.lib_screen.BaseApp;
...
public class MmkvUtils {
    ...
    public void get_demo() {
        ...
        LogUtils.e("--MmkvUtils-ceshi-", bean.getText_content());
        LogUtils.e("--MmkvUtils-ceshi2-", bean2.getText_content());
        //
        MmkvUtils.getInstance().set_common("ceshi3", "yun3");
        MmkvUtils.getInstance().set_xiancheng("ceshi4", "yun4");
        LogUtils.e("--MmkvUtils-ceshi3-", MmkvUtils.getInstance().get_common("ceshi3"));
        LogUtils.e("--MmkvUtils-ceshi3-", MmkvUtils.getInstance().get_common("ceshi3", "111"));
        LogUtils.e("--MmkvUtils-ceshi4-", MmkvUtils.getInstance().get_xiancheng_string("ceshi4"));
        LogUtils.e("--MmkvUtils-ceshi4-", MmkvUtils.getInstance().get_xiancheng_string("ceshi4", "1111"));
        //
