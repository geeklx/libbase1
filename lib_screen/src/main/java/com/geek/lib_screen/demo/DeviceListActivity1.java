...
public class DeviceListActivity1 extends AppCompatActivity {
    ...
    private ClingDeviceAdapter1 adapter;
    private List<ClingDevice> clingDevices;

    public static void startSelf(Activity context) {
        Intent intent = new Intent(context, DeviceListActivity1.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
            ...
            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                ClingDevice device = clingDevices.get(position);
