...
import com.geek.libmlkitscanner.callback.OnCameraAnalyserCallback;
import com.geek.libmlkitscanner.camera.CameraManager;
import com.geek.libmlkitscanner.model.MNScanConfig;
import com.geek.libmlkitscanner.utils.ImageUtils;
import com.geek.libmlkitscanner.utils.StatusBarUtil;
import com.geek.libmlkitscanner.view.ScanActionMenuView;
import com.geek.libmlkitscanner.view.ScanResultPointView;
import com.geek.libmlkitscanner.view.ViewfinderView;
...
public class ScanPreviewActivity1 extends AppCompatActivity {

    //用来保存当前Activity
    private static WeakReference<ScanPreviewActivity1> sActivityRef;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.mn_scan_activity_scan_previews);
        mContext = this;
...
//        ToastUtil.getInstance().showLong(this,result);
